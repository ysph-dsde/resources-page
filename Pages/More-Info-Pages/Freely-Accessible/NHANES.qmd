...
The RDG portal provides access to applications for data from 13 agencies and 3 units within the Federal Statistical System (FSS), including the NCHS. Each agency may have additional expectations for the application process that you will need to include if you are requesting data from them. While many details are available in the [RDG User Guide](https://manager.researchdatagov.org/RDG_User_Guide.pdf) or the [RDC Application Process](https://www.cdc.gov/rdc/application-process/index.html) page (some of which are summarized here), researchers are advised to contact the agencies or units from which they are requesting data before submitting their application.

Example applications, data dictionaries, and complete details can be found on the [RDC Application Process](https://www.cdc.gov/rdc/application-process/index.html) page\ [@rdc_process]. The summary provided here is intended solely to offer an outline and introduce you to the location of relevant  information. You can reach the RDC directly at rdca@cdc.gov for further information\ [@rdg_user_guide].
...
3. Complete the [Confidentiality and Disclosure](https://www.cdc.gov/rdc/application-process/confidentiality-an) training and forms, and provide them to the RDC analyst. Additional forms, documents, and tools for this step can also be found on the [RDC Reference Materials](https://www.cdc.gov/rdc/application-process/reference-materials.html) page\ [@rdc_reference_materials; @confid_disc].

4. When invoiced, you will need to pay the fees incurred by your request and applicable to accessing the data at your intended location and frequency of access. Refer to [Fees and Invoicing](https://www.cdc.gov/rdc/application-process/fees-and-invoicing.html) for complete details\ [@fees_invoicing].
:::
...
2. Upon completion of your analysis, you must submit an output request to your RDC analyst for review and approval. Find the full details about the requirements and expectations on the [Output Policies and Procedures](https://www.cdc.gov/rdc/output/index.html) page\ [@data_output].
...
7. When you have nearly completed your output, send it to your RDC analyst for review before submitting it for publication or distribution. Find the full details about requirements and expectations on the [Publishing Guidelines](https://www.cdc.gov/rdc/publishing-guidelines/index.html) page\ [@publishing_guides].
:::
...
NCHS data is available at two types of data centers: the Census Bureau's Federal Statistical Research Data Centers (FSRDC) and the NCHS Research Data Centers (RDCs). Additional details about preparing to access your data at one of these sites can be found on the RDC [Location of Access](https://www.cdc.gov/rdc/location-of-access/index.html) page or their respective subpages: [FSRDC](https://www.cdc.gov/rdc/location-of-access/federal-statistical-rdc.html) and [NCHS RDC](https://www.cdc.gov/rdc/location-of-access/nchs-rdc.html)\ [@data_locations; @fsrdc; @nchs_rdc; @rdc_process].
