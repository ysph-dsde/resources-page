...
After receiving approval, the [Harvey Cushing/John Hay Whitney Medical Library](https://library.medicine.yale.edu/), the [Yale Center for Clinical Investigation (YCCI)](https://medicine.yale.edu/center-clinical-investigation/), and YBIC will collaborate to assist with data retrieval, analysis, and ensuring compliance with data use agreements. The request form is accessible on the MarketScan Database [DataMed](https://datamed.library.medicine.yale.edu/marketscan) webpage.
